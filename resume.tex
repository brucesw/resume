...
%----------------------------------------------------------------------------------------
\section{Skillset}
Google Cloud Platform, BigQuery, Dataproc, GKE, Docker, Kubernetes, MySQL, PostegreSQL, Terraform, Datadog, Hadoop, MapReduce, Spark, Go, Java, Scala, Python, Flask, JavaScript, Node, React, HTML, CSS, Bootstrap, Git, Langchain, Linux, Spanish, FinOps\\
